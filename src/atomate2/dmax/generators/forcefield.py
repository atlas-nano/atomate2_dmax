...
def parametrize_ligpargen(
    amor, output_fname: str | None = None, include_impropers: bool = False
) -> str:
    """
...
def parametrize_foyer(
    amor,
    forcefield_name: str = "oplsaa",
    ...
    apply(
        ...
        write_impropers=include_impropers,
    )
...
def parametrize_gaff2_antechamber(amor) -> str:
    ...
    try:
        ...
        builder.get_gaff2(
            output_fname="amor_gaff2_antechamber.lmp", atom_typing="antechamber"
        )
    finally:
        os.chdir(orig_cwd)
    # return the full path to generated file
